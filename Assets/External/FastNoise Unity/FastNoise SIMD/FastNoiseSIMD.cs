...
namespace FastNoise.SIMD
{
    public class FastNoiseSIMD
    {
        ...
        public int GetSeed()
        {
            return NativeGetSeed(this.nativePointer);
        }
        ...
        {
            NativeFillNoiseSet(this.nativePointer, noiseSet, xStart, yStart, zStart, xSize, ySize, zSize,
                scaleModifier);
        }
        ...
        {
            NativeFillSampledNoiseSet(this.nativePointer, noiseSet, xStart, yStart, zStart, xSize, ySize, zSize,
                sampleScale);
        }

        public void FillNoiseSetVector(float[] noiseSet, VectorSet vectorSet, float xOffset = 0f, float yOffset = 0f,
            float zOffset = 0f)
        {
            NativeFillNoiseSetVector(this.nativePointer, noiseSet, vectorSet.nativePointer, xOffset, yOffset, zOffset);
        }

        public void FillSampledNoiseSetVector(float[] noiseSet, VectorSet vectorSet, float xOffset = 0f,
            float yOffset = 0f, float zOffset = 0f)
        {
            NativeFillSampledNoiseSetVector(this.nativePointer, noiseSet, vectorSet.nativePointer, xOffset, yOffset,
                zOffset);
        }
        ...
        public float[] GetNoiseSet(int xStart, int yStart, int zStart, int xSize, int ySize, int zSize,
            float scaleModifier = 1.0f)
        {
            var noiseSet = this.GetEmptyNoiseSet(xSize, ySize, zSize);
            NativeFillNoiseSet(this.nativePointer, noiseSet, xStart, yStart, zStart, xSize, ySize, zSize,
                scaleModifier);
            return noiseSet;
        }

        public float[] GetSampledNoiseSet(int xStart, int yStart, int zStart, int xSize, int ySize, int zSize,
            int sampleScale)
        {
            var noiseSet = this.GetEmptyNoiseSet(xSize, ySize, zSize);
            NativeFillSampledNoiseSet(this.nativePointer, noiseSet, xStart, yStart, zStart, xSize, ySize, zSize,
	...
	private const string NATIVE_LIB = "__Internal";
        ...
        [DllImport(NATIVE_LIB)]
        private static extern void NativeSetCellularDistance2Indicies(POINTER nativePointer, int cellularDistanceIndex0,
        ...
        [DllImport(NATIVE_LIB)]
        private static extern void NativeSetPerturbFractalLacunarity(POINTER nativePointer,
        ...
        [DllImport(NATIVE_LIB)]
        private static extern void NativeFillNoiseSet(POINTER nativePointer, float[] noiseSet, int xStart, int yStart,
            int zStart,
            int xSize, int ySize, int zSize, float scaleModifier);

        [DllImport(NATIVE_LIB)]
        private static extern void NativeFillSampledNoiseSet(POINTER nativePointer, float[] noiseSet, int xStart,
            int yStart, int zStart,
            int xSize, int ySize, int zSize, int sampleScale);

        [DllImport(NATIVE_LIB)]
        private static extern void NativeFillNoiseSetVector(POINTER nativePointer, float[] noiseSet,
            POINTER vectorSetPointer,
            float xOffset, float yOffset, float zOffset);

        [DllImport(NATIVE_LIB)]
        private static extern void NativeFillSampledNoiseSetVector(POINTER nativePointer, float[] noiseSet,
            POINTER vectorSetPointer,
            float xOffset, float yOffset, float zOffset);
	...
	private static void NativeFillSampledNoiseSetVector(POINTER nativePointer, float[] noiseSet, POINTER vectorSetPointer,
        ...
        public class VectorSet
        {
            ...
            public VectorSet(Vector3[] vectors, int sampleSizeX = -1, int sampleSizeY = -1, int sampleSizeZ = -1,
                int samplingScale = 0)
            {
                ...
                this.nativePointer = NewVectorSet(vectorSetArray, vectorSetArray.Length, samplingScale, sampleSizeX,
                    sampleSizeY, sampleSizeZ);
            }
            ...
            private static extern POINTER NewVectorSet(float[] vectorSetArray, int arraySize, int samplingScale,
                int sampleSizeX, int sampleSizeY, int sampleSizeZ);
